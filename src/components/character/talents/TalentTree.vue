...
const CELL_MIN = 24
const CELL_MAX = 48
// On-screen width is the display-col span — TalentTreeColumn preserves
// real empty columns (offset-normalized, not packed), and sanitizeTopology
// has already stripped the off-grid strays that used to inflate the span.
